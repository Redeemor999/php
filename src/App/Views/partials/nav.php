    ...
    <nav class="bg-gray-800">
        ...
        <div class="flex h-16 items-center justify-between">
            ...
            <div class="hidden md:block">
                ...
                <a href="/" class="<?= $uri == '/' ? 'bg-gray-900 text-white' : 'text-gray-300' ?> hover:bg-gray-700 rounded-md px-3 py-2 text-sm font-medium text-white" aria-current="page">Home</a>
                <a href="/notes" class="<?= $uri == '/notes' ? 'bg-gray-900 text-white' : 'text-gray-300' ?>rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Notes</a>
                <a href="/about" class="<?= $uri == '/about' ? 'bg-gray-900 text-white' : 'text-gray-300' ?>rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">About</a>
                <a href="/contact" class="<?= $uri == '/contact' ? 'bg-gray-900 text-white' : 'text-gray-300' ?>rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Contact</a>
            ...
            <div class="ml-4 flex items-center md:ml-6">
                ...
                <div>
                    ...
                    <?php else: ?>
                        ...
                        <a href="/users/login" class="ml-4 text-white">Log In</a>
                    <?php endif ?>
                    </button>
                </div>
